...
for file in files:
  tabu_search = TS_CSP(ternure_porcent=0.2, iterations=10000, max_time=max_time, instance_file=file, improve='first')
...
# tabu_search = TS_CSP(ternure_porcent=0.3, iterations=1000, max_time=max_time, instance_file='eil76-11.csp2', improve='best')
